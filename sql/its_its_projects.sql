...
--
-- Table structure for table `its_projects`
--

DROP TABLE IF EXISTS `its_projects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `its_projects` (
...
--
-- Dumping data for table `its_projects`
--

LOCK TABLES `its_projects` WRITE;
/*!40000 ALTER TABLE `its_projects` DISABLE KEYS */;
/*!40000 ALTER TABLE `its_projects` ENABLE KEYS */;
UNLOCK TABLES;
