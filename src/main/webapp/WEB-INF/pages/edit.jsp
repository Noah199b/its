	...
	<body>
		...
		<div class="inside_wrap">
			<div class="inside_con">
				<div class="adr">
					<a href="indexUI.do">首页</a>&nbsp;>&nbsp;<a href="bbs.do">微·论坛</a>>&nbsp;编辑话题
				</div>
						...
						<div class="public_box">
							...
							<form id="form_publish_id" action="" method="post">
								...
								<div class="editor">
								    ...
								    <button type="submit" id="btn_submit" class="btn submit_btn" value="${its_user.id}">保存</button>	
								    <button type="button" class="btn submit_btn" onclick="doCancel();">取消</button>							     
								</div>
							</form>
						</div>
					</div>
		...
		<script src="its/bbs/edit.js" type="text/javascript"></script>
	</body>
</html>